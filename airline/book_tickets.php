	...
	<img class="logo1" src="flightlylogo.jpg"/> 
		...
		<form action="view_flights_form_handler.php" method="post">
			...
			<table cellpadding="5">
				...
				<tr>
					<td class="fix_table">
						<input list="origins" type="text" name="origin" placeholder="From" required>
  						<datalist id="origins">
					...
					<td class="fix_table">
						<input list="destinations"  type="text" name="destination" placeholder="To" required>
  						<datalist id="destinations">
						  <option value="Ilocos Norte (LAO)">
  						  	<option value="Puerto  Prinsesa (PPS)">
  						  	<option value="Kalibo (KLO)">
  						  	<option value="Iloilo (ILO)">
  						  	<option value="Davao (DVO)">
							<option value="General Santos (GES)">
							<option value="Beijing, China (PEK)">
							<option value="Chiba, Japan (NRT)">
							<option value="Indonesia (CGK)">
							<option value="Incheon, South Korea (ICN)">
							<option value="Thailand (BKK)">
							<option value="Mumbai, India (BOM)">
							<option value="Malaysia (KUL)">
							<option value="Hongkong (HKG)">
							<option value="Singapore (SIN)">
							<option value="Delhi, India (DEL)">
							<option value="Bahrain (BAH)">
							<option value="MLE (Maldives)">
  						</datalist>
			...
			<br>
			<center><input type="submit" value="Search for Available Flights" name="Search">
		</form></center>
